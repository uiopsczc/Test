...
namespace CsCat
{
  ...
  public class AOPHandler : ISingleton
  {
    ...
    {
      var aopAttributeMethodInfoProxyCategory_list = GetAOPAttributeMethodInfoProxyCategoryList(source_methodBase);
      aopAttributeMethodInfoProxyCategory_list.ForEach(
        aopAttributeMethodCategory =>
        {
          InvokeAOPAttributeMethod(aopAttributeMethodCategory, AOPMethodType.Pre_AOP_Handle, source_method_owner,
      ...
      params object[] source_method_args)
    {
      ...
      aopAttributeMethodCategory_list.ForEach(
        aopAttributeMethodCategory =>
        {
          InvokeAOPAttributeMethod(aopAttributeMethodCategory, AOPMethodType.Post_AOP_Handle, source_method_owner,
            source_methodBase, source_method_args);
        }
      );
    }
      ...
      params Type[] source_method_parameter_types)
    {
      ...
      return AOPUtil.SeachTargetMethodInfoProxy(aop_attriubte_type, source_methodBase.DeclaringType, source_method_name,
