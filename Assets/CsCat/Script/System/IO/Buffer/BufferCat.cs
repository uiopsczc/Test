...
namespace CsCat
{
  public abstract class BufferCat
  {
    ...
    private readonly byte[] single_byte_buf = new byte[1];
    ...
    public short GetShort(int pos)
    {
      var buf = new byte[2];
      Get(pos, buf);
      return ByteUtil.ToShort(buf, 0, NetOrder() ? true : false);
    }
    ...
    public int GetInt(int pos)
    {
      var buf = new byte[4];
      Get(pos, buf);
      return ByteUtil.ToInt(buf, 0, NetOrder() ? true : false);
    }
    ...
    public long GetLong(int pos)
    {
      var buf = new byte[8];
      Get(pos, buf);
      return ByteUtil.ToLong(buf, 0, NetOrder() ? true : false);
    }
    ...
    {
      Append(ByteUtil.ToBytes(value, 0, NetOrder() ? true : false));
    }
