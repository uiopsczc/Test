namespace CsCat
{
	...
	{
		public static ArrayCat<P0> New<P0>(P0 data0)
		{
			return new ArrayCat<P0>(data0);
		}

		public static ArrayCat<P0, P1> New<P0, P1>(P0 data0, P1 data1)
		{
			return new ArrayCat<P0, P1>(data0, data1);
		}

		public static ArrayCat<P0, P1, P2> New<P0, P1, P2>(P0 data0, P1 data1, P2 data2)
		{
			return new ArrayCat<P0, P1, P2>(data0, data1, data2);
		}

		public static ArrayCat<P0, P1, P2, P3> New<P0, P1, P2, P3>(P0 data0, P1 data1, P2 data2, P3 data3)
		{
