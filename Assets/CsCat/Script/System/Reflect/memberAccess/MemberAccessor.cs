...
namespace CsCat
{
  ...
  public abstract class MemberAccessor
  {
    ...
    ///   该属性类型
    /// </summary>
    public abstract Type member_type { get; }
    ...
    {
      if (declaring_type.IsValueType) //是否为值类型
        generator.Emit(OpCodes.Unbox, declaring_type);
      else //非值类型，用class解析
        generator.Emit(OpCodes.Castclass, declaring_type);
    }
