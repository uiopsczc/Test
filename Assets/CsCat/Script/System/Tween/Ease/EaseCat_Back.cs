namespace CsCat
{
  ...
  public partial class EaseCat
  {
    public class Back : EaseCat
    {
      ...
      public static float EaseIn2(float start_value, float end_value, float pct, float s)
      {
        return EaseIn(pct, start_value, end_value - start_value, 1, s);
      }

      public static float EaseOut2(float start_value, float end_value, float pct, float s)
      {
        return EaseOut(pct, start_value, end_value - start_value, 1, s);
      }

      public static float EaseInOut2(float start_value, float end_value, float pct, float s)
      {
        return EaseInOut(pct, start_value, end_value - start_value, 1, s);
      }
    }
  }
}