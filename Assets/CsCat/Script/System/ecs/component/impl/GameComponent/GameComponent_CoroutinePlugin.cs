...
namespace CsCat
{
  ...
  {
    protected CoroutinePlugin coroutinePlugin => cache.GetOrAddDefault(() => new CoroutinePlugin(GetGameEntity().GetComponent<CoroutinePluginComponent>().coroutinePlugin.mono));
