...
namespace CsCat
{
  public partial class PoolCatManager : ISingleton
  {
    ...
    public object Spawn(Type spawn_type, Action<object> on_spawn_callback = null)
    {
      var spawn_type_name = spawn_type.ToString();
      var pool = pool_dict.GetOrAddDefault(spawn_type_name, () => new PoolCat(spawn_type_name, spawn_type));
