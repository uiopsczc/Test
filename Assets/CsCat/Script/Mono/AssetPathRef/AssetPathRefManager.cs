  ...
  public class AssetPathRefManager : ISingleton
  {
    ...
    void SingleInit()
    {
      ...
      if (EditorModeConst.Is_Editor_Mode)
        LoadFromPath(AssetPathRefConst.Save_File_Path.WithRootPath(FilePathConst.ProjectPath));
    }
    ...
    public void ClearAll()
    {
      dict.Clear();
      ref_id = 0;
      StdioUtil.RemoveFile(new FileInfo(AssetPathRefConst.Save_File_Path.WithRootPath(FilePathConst.ProjectPath)));
    }
    ...
    public void Save()
    {
      ...
      StdioUtil.WriteTextFile(AssetPathRefConst.Save_File_Path.WithRootPath(FilePathConst.ProjectPath), content_json);
    }
