...
namespace CsCat
{
	...
	public class AssetBuildInfo : IComparable<AssetBuildInfo>
	{
		...
		private bool _beforeExportProcess;
		...
		public AssetBuildInfo(Object obj, FileInfo fileInfo, string assetPath)
		{
			...
			this.assetBundlePath = assetPath;
			int index = assetPath.LastIndexOf(".");
			if (index != -1)
				this.assetBundlePath = assetPath.Substring(0, index);
		}
		...
		{
			if (_beforeExportProcess) return;
			_beforeExportProcess = true;
