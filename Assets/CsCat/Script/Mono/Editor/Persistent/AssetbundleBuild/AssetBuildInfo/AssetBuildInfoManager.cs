...
namespace CsCat
{
	...
	{
		public static AssetBuildInfoManager Instance => SingletonFactory.instance.Get<AssetBuildInfoManager>();
		...
		public void AddRootTargets(DirectoryInfo bundleDir, string[] patterns = null,
			SearchOption searchOption = SearchOption.AllDirectories)
		{
			...
			{
				FileInfo[] fileInfos = bundleDir.GetFiles(pattern, searchOption);
