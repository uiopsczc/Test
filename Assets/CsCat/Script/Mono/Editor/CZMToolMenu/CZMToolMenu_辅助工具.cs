...
namespace CsCat
{
  ...
  public partial class CZMToolMenu
  {
    ...
    ///   _t:t
    /// </summary>
    [MenuItem(CZMToolConst.MenuRoot + "辅助工具/显示时间设置 %&#t")]
    //crtl+alt+shift+t
    ...
    [MenuItem(CZMToolConst.AssetMenuRoot + "辅助工具/复制路径(相对于Project) %&#p")] //crtl+alt+shift+p  %&#p 
    [MenuItem(CZMToolConst.GameObjectMenuRoot + "辅助工具/复制路径")]
    ...
    [MenuItem(CZMToolConst.AssetMenuRoot + "辅助工具/复制Resource路径")]
