  ...
  public class AssetBundleUpdater : TickObject
  {
    ...
    public IEnumerator CheckUpdate()
    {
      ...
      if (!ObjectUtil.Equals(client_buildInfo.assetPathRef_content_json, server_buildInfo.assetPathRef_content_json))
        StdioUtil.WriteTextFile(client_buildInfo.WithRootPathOfUrlRoot(AssetPathRefConst.Save_File_Name).Trim(),
    ...
    {
      StdioUtil.WriteTextFile(BuildConst.Res_Version_File_Name.WithRootPath(FilePathConst.PersistentAssetBundleRoot),
