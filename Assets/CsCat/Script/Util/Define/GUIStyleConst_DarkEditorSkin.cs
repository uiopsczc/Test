...
namespace CsCat
{
    public static partial class GUIStyleConst
    {
        ...
        public static GUIStyle Button_Style => _Button_Style ?? (_Button_Style = editor_skin_dark.FindStyle("button"));

        private static GUIStyle _Toggle_Style;

        public static GUIStyle Toggle_Style => _Toggle_Style ?? (_Toggle_Style = editor_skin_dark.FindStyle("toggle"));
        ...
        public static GUIStyle Thin_Help_Box => _Thin_Help_Box ?? (_Thin_Help_Box = new GUIStyle(Help_Box)
        {
