...
//      GUILayout.FlexibleSpace();
    ...
    public EditorGUILayoutBeginVerticalIndentLevelScope(GUIStyle style, int add = 1, params GUILayoutOption[] options)
    {
      _Init(add);
      EditorGUILayout.BeginVertical(style, options);
    }

    public EditorGUILayoutBeginVerticalIndentLevelScope(ref Rect rect, int add = 1, params GUILayoutOption[] options)
    {
      _Init(add);
      rect = EditorGUILayout.BeginVertical(options);
    }

    public EditorGUILayoutBeginVerticalIndentLevelScope(ref Rect rect, GUIStyle style, int add = 1, params GUILayoutOption[] options)
    {
      _Init(add);
