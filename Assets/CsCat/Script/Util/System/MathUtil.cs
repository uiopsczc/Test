...
namespace CsCat
{
  ...
  {
    public static Vector3 GetPoint(Vector3 sp, Vector3 dir, float distance)
    {
      dir.Normalize();
      return sp + dir * distance;
    }

    public static Vector2 GetPoint(Vector2 sp, Vector2 dir, float distance)
    {
      dir.Normalize();
      return sp + dir * distance;
    }
    ...
    public static float GetDiffAngle(Vector2 dir1, Vector2 dir2)
    {
      ...
      var diff_angle = Mathf.Acos(cos) * Mathf.Rad2Deg; //夹角
    ...
    public static Line GetLine(Vector2 ep, Vector2 dir, float x)
    {
      var k = (ep.x - x) / dir.x;
      var y = ep.y - k * dir.y;
      var sp = new Vector2(x, y);
    ...
    public static long A(long m, long n)
    {
      ...
      var n_m_fac = Factorial(n - m);
      return n_fac / n_m_fac;
    }
