...
namespace XLua.CSObjectWrap
{
    ...
    public class CsCatUINotifyManagerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(CsCat.UINotifyManager);
			Utils.BeginObjectRegister(type, L, translator, 0, 4, 0, 0);
			
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "LanternNotify", _m_LanternNotify);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "__LanternNotify", _m___LanternNotify);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "Notify", _m_Notify);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "PreNotify", _m_PreNotify);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					CsCat.UINotifyManager gen_ret = new CsCat.UINotifyManager();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to CsCat.UINotifyManager constructor!");
        ...
        static int _m_LanternNotify(RealStatePtr L)
        {
		    try {
                ...
                CsCat.UINotifyManager gen_to_be_invoked = (CsCat.UINotifyManager)translator.FastGetCSObj(L, 1);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m___LanternNotify(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.__LanternNotify(  );
        ...
        static int _m_Notify(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 4&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& translator.Assignable<UnityEngine.Transform>(L, 3)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 4)) 
                {
                    ...
                    gen_to_be_invoked.Notify( _desc, _parent, _is_add_to_child_panel_stack );
                ...
                if(gen_param_count == 3&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& translator.Assignable<UnityEngine.Transform>(L, 3)) 
                {
                    ...
                    gen_to_be_invoked.Notify( _desc, _parent );
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to CsCat.UINotifyManager.Notify!");
            
        }
        
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_PreNotify(RealStatePtr L)
        {
		    try {
