...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineAudioSourceWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 18, 28, 26);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "SetAudioMixerOutput", _m_SetAudioMixerOutput);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					UnityEngine.AudioSource gen_ret = new UnityEngine.AudioSource();
		    ...
		    try {
                ...
                
                {
                    UnityEngine.AudioSourceCurveType _type;translator.Get(L, 2, out _type);
                        ...
                        UnityEngine.AnimationCurve gen_ret = gen_to_be_invoked.GetCustomCurve( _type );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _value = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        bool gen_ret = gen_to_be_invoked.SetSpatializerFloat( _index, _value );
		    ...
		    try {
                ...
                
                {
                    ...
                    float _value;
                        ...
                        bool gen_ret = gen_to_be_invoked.GetSpatializerFloat( _index, out _value );
                        LuaAPI.lua_pushboolean(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _value;
                        ...
                        bool gen_ret = gen_to_be_invoked.GetAmbisonicDecoderFloat( _index, out _value );
                        LuaAPI.lua_pushboolean(L, gen_ret);
                    LuaAPI.lua_pushnumber(L, _value);
		    ...
		    try {
                ...
                
                {
                    ...
                    float _value = (float)LuaAPI.lua_tonumber(L, 3);
                        ...
                        bool gen_ret = gen_to_be_invoked.SetAmbisonicDecoderFloat( _index, _value );
                        LuaAPI.lua_pushboolean(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_SetAudioMixerOutput(RealStatePtr L)
        {
		    try {
                ...
                if(gen_param_count == 3&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)&& translator.Assignable<UnityEngine.Audio.AudioMixer>(L, 3)) 
                {
                    string _group_name = LuaAPI.lua_tostring(L, 2);
                    UnityEngine.Audio.AudioMixer _audioMixer = (UnityEngine.Audio.AudioMixer)translator.GetObject(L, 3, typeof(UnityEngine.Audio.AudioMixer));
                    
                        bool gen_ret = gen_to_be_invoked.SetAudioMixerOutput( _group_name, _audioMixer );
                        LuaAPI.lua_pushboolean(L, gen_ret);
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    string _group_name = LuaAPI.lua_tostring(L, 2);
                        ...
                        bool gen_ret = gen_to_be_invoked.SetAudioMixerOutput( _group_name );
                        LuaAPI.lua_pushboolean(L, gen_ret);
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.AudioSource.SetAudioMixerOutput!");
