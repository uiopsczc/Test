...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public void __Gen_Delegate_Imp16(float p0, float p1)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp17(CsCat.AssetCat p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp18(CsCat.Act p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp19(System.Action p0)
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public float __Gen_Delegate_Imp20()
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public UnityEngine.Vector3 __Gen_Delegate_Imp21()
		{
#if THREAD_SAFE || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new System.Action<float, float>(__Gen_Delegate_Imp16);
			}
		
		    if (type == typeof(System.Action<CsCat.AssetCat>))
			{
			    return new System.Action<CsCat.AssetCat>(__Gen_Delegate_Imp17);
			}
		
		    if (type == typeof(System.Action<CsCat.Act>))
			{
			    return new System.Action<CsCat.Act>(__Gen_Delegate_Imp18);
			}
		
		    if (type == typeof(System.Action<System.Action>))
			{
			    return new System.Action<System.Action>(__Gen_Delegate_Imp19);
			}
		
		    if (type == typeof(System.Func<float>))
			{
			    return new System.Func<float>(__Gen_Delegate_Imp20);
			}
		
		    if (type == typeof(System.Func<UnityEngine.Vector3>))
			{
			    return new System.Func<UnityEngine.Vector3>(__Gen_Delegate_Imp21);
			}
