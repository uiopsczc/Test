...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineComponentWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "GetOrNewGameObject", _m_GetOrNewGameObject);
        ...
        static int _m_NewChildGameObject(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Component.NewChildGameObject!");
        ...
        static int _m_NewChildWithComponent(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Component.NewChildWithComponent!");
        ...
        static int _m_NewChildWithRectTransform(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Component.NewChildWithRectTransform!");
        ...
        static int _m_NewChildWithImage(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Component.NewChildWithImage!");
        ...
        static int _m_NewChildWithText(RealStatePtr L)
        {
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to UnityEngine.Component.NewChildWithText!");
            
        }
        
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_GetOrNewGameObject(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    string _path = LuaAPI.lua_tostring(L, 2);
                        ...
                        UnityEngine.GameObject gen_ret = gen_to_be_invoked.GetOrNewGameObject( _path );
                        translator.Push(L, gen_ret);
